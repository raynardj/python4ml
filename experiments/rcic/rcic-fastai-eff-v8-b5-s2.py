...
SIZE = 456
SITE = 2 # Site: 1:site1, 2:site2, 3:site1 and 2
LR = 1e-5
BS = 28
EPOCHS = 18
MODEL_TYPE = "b5"
LOAD = True # do we load the trained weights
LOAD_NAME = "/home/paperspace/rcic-b5-sz456-bs26-s1-s2-r2"
SAVE_NAME = "rcic-%s-sz%s-bs%s-s%s"%(MODEL_TYPE,SIZE,BS,SITE)+""
USE_PSEUDO = True # use pseudo labeling
#SUB = Path("/home/hadoop/github/python4ml/experiments/rcic/submissions/") # submit directory
SUB = Path("/home/paperspace/csv/") # submit directory
PSEUDO = SUB/"submission_ens_4b3_b4_2b5.csv"
...
DATA = Path("/home/paperspace/cell")
...
learn.path = Path('/home/paperspace/cell')
